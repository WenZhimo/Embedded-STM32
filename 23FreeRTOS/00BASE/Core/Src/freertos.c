...
/* USER CODE BEGIN Header_myTask_LED_R_f */
/**
* @brief Function implementing the myTask_LED_R thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_myTask_LED_R_f */
__weak void myTask_LED_R_f(void *argument)
{
  /* USER CODE BEGIN myTask_LED_R_f */
  /* Infinite loop */
  for(;;)
  {
      printf("lib05\n");
