/**
  ******************************************************************************
  * @file    usb_app.h
  * @brief   U盘应用层底层驱动 (支持 N 个常开槽位与动态切换)
  ******************************************************************************
  */
#ifndef __USB_APP_H
#define __USB_APP_H
...
/* ================= 1. 核心宏定义 ================= */
#define USB_USE_RTOS         1     // 1: 启用 FreeRTOS 支持, 0: 裸机模式
#define MAX_FAST_SLOTS       10     // 定义系统支持的最大常开文件槽位数量 (如 10 个字库)要确保FATFS设置里的_FS_LOCK不小于这个数
...
/* ================= 2. 状态码定义 ================= */
#define USB_STATUS_OK        0x00  // 操作成功
#define USB_STATUS_ERROR     0x01  // 操作失败
#define USB_STATUS_OVERFLOW  0x02  // 数值溢出
