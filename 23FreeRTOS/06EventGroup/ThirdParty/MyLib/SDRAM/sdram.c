...
/**
 * @brief 从SDRAM读取8位数据缓冲区
 * @param addr SDRAM中的偏移地址
 * @param data 用于存储读取数据的缓冲区
 * @param len 要读取的数据长度（字节数）
 * @note 该函数从SDRAM的指定地址逐字节读取数据到数据缓冲区
 *       源地址 = SDRAM基地址 + 偏移地址
 */
