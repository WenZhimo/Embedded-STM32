...
#define LCD_BL_GPIO_PIN                 GPIO_PIN_5     /* 背光改到了 PB5 */
 ...
 */
/* FMC相关参数 定义 (F429使用的是FMC) */
#define LCD_FSMC_NEX         1              /* 原理图使用FMC_NE1 */
#define LCD_FSMC_AX          18             /* 原理图使用FMC_A18 */

/* 将底层的 FSMC_Bank1 全部改为 FMC_Bank1 */
#define LCD_FSMC_BCRX        FMC_Bank1->BTCR[(LCD_FSMC_NEX - 1) * 2]       
#define LCD_FSMC_BTRX        FMC_Bank1->BTCR[(LCD_FSMC_NEX - 1) * 2 + 1]   
#define LCD_FSMC_BWTRX       FMC_Bank1E->BWTR[(LCD_FSMC_NEX - 1) * 2]
